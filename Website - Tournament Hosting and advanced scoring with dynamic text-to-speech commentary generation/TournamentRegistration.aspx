...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TournamentRegistration.aspx.cs" Inherits="TournamentRegistration" %>
                ...
                <div class="x_content">
                    ...
                    <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <asp:TextBox ID="txtTotalTeams" runat="server"></asp:TextBox>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtTotalTeams"
                                runat="server" ErrorMessage="Field is empty"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <asp:TextBox ID="txtTotalOvers" runat="server"></asp:TextBox>
                            </div>
                        ...
                        <div class="x_title">
                            <h2>
                                Tournament Manager Registration</h2>
                            <div class="clearfix">
                            </div>
                        </div>
                        <div class="form-group">
